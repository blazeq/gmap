...
$query_autosta = "select 十分风速 from stasync WHERE 十分风速 is not null and 区站号 = '$id' and 日期时间 = '$ymdh'";//WHERE 十分风速 is not null and 区站号 = 'D2001' and 日期时间 = '$ymdh'
$result = odbc_do($con_dajian,$query_autosta);
$num=0;
while(odbc_fetch_row($result))
{
	$temp = odbc_result($result, "十分风速")/10;
...
if($num > 0)
{
	...
	imagettftext($image_weifang, 9, 0, 45,30, $color_black_dot, $font, $temp);
	//imagettftext($image_weifang, 9, 0, 46,30, $color_black_dot, $font, $temp);
}
else
{
